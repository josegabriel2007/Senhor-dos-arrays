...
public class escolha {
    ...
    ImageIcon elfoIcon = new ImageIcon("src/Cenarios/elfo.png");
    ...
    ImageIcon guerreiroIcon = new ImageIcon("src/Cenarios/guerreiro.png");
    ...
    ImageIcon barbaroIcon = new ImageIcon("src/Cenarios/barbaro.png");
