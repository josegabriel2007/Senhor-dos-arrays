...
public class TelaAjuda extends JPanel {
    ...
    public TelaAjuda(){
        ...
        JTextArea texto1 = new JTextArea("CLASSES: ELFOS não tem muita força física, no entanto são uma raça com muita vitalidade, então naturalmente eles tem mais pontos de vida e poucos pontos de ataque. GUERREIROS são bem equilibrados devido ao seu treinamento, os pontos de vida e ataque são um perfeito meio termo. BARBAROS agem sem pensar mas naturalmente tem mais força física, mas o seu descuido impede ele de defender bem os ataques, eles tem mais pontos de ataque e menos pontos de vida.");
        ...
        JTextArea texto2 = new JTextArea("Falta escrever aqui");
        ...
        JTextArea texto3 = new JTextArea("Falta escrever aqui");
